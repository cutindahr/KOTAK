...
// --> General settings
$hesk_settings['site_title']='BPS Aceh';
$hesk_settings['site_url']='https://aceh.bps.go.id';
$hesk_settings['hesk_title']='Konsultasi Tata Usaha OK';
$hesk_settings['hesk_url']='http://localhost/kotak/';
$hesk_settings['webmaster_mail']='admin@qna.bpsaceh.com';
...
$hesk_settings['db_name']='kotak';
$hesk_settings['db_user']='root';
$hesk_settings['db_pass']='';
$hesk_settings['db_pfix']='qna_';
...
$hesk_settings['secimg_sum']='XSBLHPB48A';
...
$hesk_settings['url_key']='Yarvb4C8W3Vuhy_H_92bszr1';
...
// --> Email sending
$hesk_settings['noreply_mail']='admin@qna.bpsaceh.com';
$hesk_settings['noreply_name']='Admin QnA BPS Aceh [mohon tidak membalas email ini]';
...
$hesk_settings['ticket_list']=array('trackid','lastchange','category','name','subject','status','lastreplier');
