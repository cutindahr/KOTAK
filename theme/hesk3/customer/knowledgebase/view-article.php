                    ...
                    <div class="ticket__body">
                        <article class="ticket__body_block naked">
                            ...
                            <div class="block--uploads">
                                ...
                                &raquo;
                                <svg class="icon icon-attach" stroke="#0094DE" stroke-width="0.5">
                                    <use xlink:href="<?php echo TEMPLATE_PATH; ?>customer/img/sprite.svg#icon-attach"></use>
                                </svg>
                                <a style="color: #0094DE; text-decoration: none; font-weight: bold;" title="<?php echo $hesklang['dnl']; ?>" href="download_attachment.php?kb_att=<?php echo $attachment['id']; ?>" rel="nofollow">
